...
public class Level2Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private final int MAX_NUMBER_OF_HIT = 3;
    ...
    private void shuffleButtonGraphics() {
        ...
        for (int i = 0; i < numberOfElements; i++) {
            ...
            int swapIndex = random.nextInt(2*3);
                ...
                reference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if(userProfile != null){
                            ...
                            if(userProfile.getUnlockedLevels() == 2) {
                                reference.child(user.getUid()).child("unlockedLevels").setValue(3);
                            }
                        }
                    }
