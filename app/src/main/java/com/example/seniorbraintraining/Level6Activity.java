...
public class Level6Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private final int MAX_NUMBER_OF_HIT = 10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        score = 0;
        hit = false;  //variable to verify if the player catch it or not
        ...
        buttonGraphics[8] = R.drawable.image_9;
        buttonGraphics[9] = R.drawable.image_10;
    ...
    private void shuffleButtonGraphics() {
        ...
        for (int i = 0; i < numberOfElements; i++) {
            ...
            int swapIndex = random.nextInt(4*5);
            ...
            if (currentNumberOfMatches == MAX_NUMBER_OF_HIT){
                ...
                reference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if(userProfile != null){
                            int currentLevel = userProfile.getUnlockedLevels();

                            if(currentLevel == 6) {
                                reference.child(user.getUid()).child("unlockedLevels").setValue(7);
                            }
                        }
                    }
