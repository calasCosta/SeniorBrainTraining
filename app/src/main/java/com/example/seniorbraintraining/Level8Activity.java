...
public class Level8Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    private final int MAX_NUMBER_OF_HIT = 6;
    ...
    private void shuffleButtonGraphics() {
        ...
        for (int i = 0; i < numberOfElements; i++) {
            ...
            int swapIndex = random.nextInt(4*3);
                ...
                reference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if(userProfile != null){
                            ...
                            if(currentLevel <= 8) {
                                reference.child(user.getUid()).child("unlockedLevels").setValue(9);
                            }
                        }
                    }
